...
export default function Balloons() {
  //FOR GALLERY
  const totalImages = 10; // Change this to the actual number of images you have in the /balloons/ folder
  ...
  return (
    <div className="balloons-div">
      <h2 className="great-vibes-regular">7 Balloons</h2>
