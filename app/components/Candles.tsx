...
export default function Candles() {
  //FOR GALLERY
  const totalImages = 10; // Change this to the actual number of images you have in the /candles/ folder
  ...
  return (
    <div className="candles-div">
      <h2 className="great-vibes-regular">7 Candles</h2>
